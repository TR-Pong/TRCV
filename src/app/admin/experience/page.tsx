          ...
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-slate-200">
              <thead className="bg-indigo-50/60">
                <tr>
                  <th className="px-4 py-3 text-left text-[11px] font-semibold uppercase tracking-[0.14em] text-indigo-500">Company</th>
                  <th className="px-4 py-3 text-left text-[11px] font-semibold uppercase tracking-[0.14em] text-indigo-500">Role</th>
                  <th className="px-4 py-3 text-left text-[11px] font-semibold uppercase tracking-[0.14em] text-indigo-500">Period</th>
                  <th className="px-4 py-3 text-left text-[11px] font-semibold uppercase tracking-[0.14em] text-indigo-500">Points</th>
            ...
            <FormCard title="Description Points">
              ...
              <div className="space-y-3">
                {editingItem.description.map((description, index) => (
                  <div key={`${index}-${description.en}`} className="admin-surface-soft rounded-xl p-4">
